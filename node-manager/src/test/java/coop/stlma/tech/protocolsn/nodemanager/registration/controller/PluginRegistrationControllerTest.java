package coop.stlma.tech.protocolsn.nodemanager.registration.controller;

import coop.stlma.tech.protocolsn.nodemanager.registration.api.RegistrationOperations;
...
class PluginRegistrationControllerTest {
    ...
    void testRegisterPlugin_happyPath() {
        ...
        Assertions.assertEquals("localhost", pluginRegistration.getPluginLocation());
        Assertions.assertEquals(8082, pluginRegistration.getPluginGrpcPort());
    }
}
