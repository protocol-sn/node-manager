...
class PluginRegistrationRepositoryTest extends RepositoryTest {
    ...
    void testFindAll_happyPath() {
        pluginRepository.save(new PluginRegistrationEntity(UUID.nameUUIDFromBytes("blog-plugin".getBytes()),
                "blog-plugin", "localhost:8082")).block();
        pluginRepository.save(new PluginRegistrationEntity(UUID.nameUUIDFromBytes("blog-plugin-2".getBytes()),
                "blog-plugin-2", "localhost:8083")).block();
